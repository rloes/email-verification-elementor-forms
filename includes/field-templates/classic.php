...
<span role="button" class="send-code-again" tabindex="0">
    ...
    <span class="success elementor-message elementor-message-success"><?= $success_text ?></span>
    <span class="error elementor-message elementor-message-danger"><?= $error_text ?></span>
    <?= $loader_html ?>
</span>
